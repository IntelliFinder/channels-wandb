...
parser.add_argument('--proj_name', type=str, default="channels_egnn_nbody", metavar='N',
                    help='name of proj')
parser.add_argument('--count', type=int, default=10, metavar='N',
                    help='num of agents (jobs_ in wandb')
...
def main():
    ...
    optimizer = optim.Adam(model.parameters(), lr=config.lr, weight_decay=args.weight_decay)
